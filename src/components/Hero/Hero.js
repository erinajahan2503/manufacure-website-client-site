...
import computer from '../../assets/images/lens.jpg';
const Hero = () => {
  return (
    <>
      ...
      <div class="hero">
        <div class="hero-content flex-col lg:flex-row-reverse">
          ...
          <div className=''>
            ...
            <h1 class="text-5xl lg:text-6xl font-bold text-primary md:leading-normal "> Exclusive <span className='text-secondary font-bold'>Camera</span> Hardware Fair</h1>
